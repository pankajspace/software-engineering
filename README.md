...
5. [CSS Layouts FEM](https://frontendmasters.com/courses/css-layouts/)
...
3. [Typescript: The Complete Developer's Guide](https://www.udemy.com/course/typescript-the-complete-developers-guide/)
...
1. [PWA](https://web.dev/learn/pwa)
2. [PWA FEM](https://frontendmasters.com/courses/pwas/)

## Python

1. [YT TNN](https://www.youtube.com/playlist?list=PL4cUxeGkcC9goeb7U1FXFdNszWetCmhfB)
