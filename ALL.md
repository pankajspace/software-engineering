...
2. [How the web works MDN](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/How_the_Web_works)
3. [Web mechanics MDN](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/Web_mechanics)
...
2. [JavaScript language overview MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Language_overview)
3. [JavaScript Guide MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide)
4. [JavaScript data types and data structures MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures)
5. [JavaScript Type Conversions](https://www.programiz.com/javascript/type-conversion)
6. [Equality comparisons and sameness MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Equality_comparisons_and_sameness)
7. [Enumerability and ownership of properties MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Enumerability_and_ownership_of_properties)
8. [Closures MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Closures)
9. [Inheritance and the prototype chain MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain)
10. [Memory management MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Memory_management)
11. [The event loop MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Event_loop)
12. !!! [Event Loop FULL Advanced JavaScript Concepts YT](https://www.youtube.com/watch?v=lMKhJPbK0HE)
13. [Manipulating documents MDN](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Client-side_web_APIs/Manipulating_documents)
14. [Client-side storage MDN](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Client-side_web_APIs/Client-side_storage)
15. [JavaScript reference MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference)
16. [Advanced Javascript Concepts YT](https://www.youtube.com/playlist?list=PL0Zuz27SZ-6N3bG4YZhkrCL3ZmDcLTuGd)
17. [Javascript Interview Questions YT](https://www.youtube.com/playlist?list=PLKhlp2qtUcSaCVJEt4ogEFs6I41pNnMU5)
18. [JavaScript: The Advanced Concepts UDM ZTM](https://www.udemy.com/course/advanced-javascript-concepts/)
19. [Deep JavaScript Foundations v3 FEM](https://frontendmasters.com/courses/deep-javascript-v3/)
20. [JavaScript: The Recent Parts FEM](https://frontendmasters.com/courses/js-recent-parts/)
21. [JavaScript: The Hard Parts v2 FEM](https://frontendmasters.com/courses/javascript-hard-parts-v2/)
22. [Rethinking Asynchronous JavaScript FEM](https://frontendmasters.com/courses/rethinking-async-js/)
23. [The Hard Parts of Asynchronous JavaScript FEM](https://frontendmasters.com/courses/javascript-new-hard-parts/)
24. [Hardcore Functional Programming in JavaScript v2 FEM](https://frontendmasters.com/courses/hardcore-js-v2/)
25. [Functional-Light JavaScript v3 FEM](https://frontendmasters.com/courses/functional-javascript-v3/)
26. [The Hard Parts of Object Oriented JavaScript FEM](https://frontendmasters.com/courses/object-oriented-js/)
27. [Hardcore Functional Architecture Patterns in JavaScript FEM](https://frontendmasters.com/courses/hardcore-js-patterns/)
28. [Advanced Web Development Quiz FEM](https://frontendmasters.com/courses/web-dev-quiz/)
...
2. [Web performance MDN](https://developer.mozilla.org/en-US/docs/Learn/Performance)
3. [Web Performance MDN](https://developer.mozilla.org/en-US/docs/Web/Performance)
4. [Web Performance Fundamentals FEM](https://frontendmasters.com/courses/web-perf/)
...
1. [React Router in Depth YT TNN](https://www.youtube.com/playlist?list=PL4cUxeGkcC9iVKmtNuCeIswnQ97in2GGf)
...
2. [React Testing Library with Jest / Vitest UDM](https://www.udemy.com/course/react-testing-library/)
...
1. [Webpack 5 in 2023: The Complete Guide For Beginners UDM](https://www.udemy.com/course/webpack-from-beginner-to-advanced/)
2. [Webpack 5 Crash Course | Frontend Development Setup YT](https://www.youtube.com/watch?v=IZGNcSuwBZs)
...
2. [Redis: The Complete Developer's Guide UDM](https://www.udemy.com/course/redis-the-complete-developers-guide-p/)
3. [Redis Caching in NodeJs YT](https://www.youtube.com/watch?v=oaJq1mQ3dFI)
...
1. [Design Patterns in JavaScript UDM](https://www.udemy.com/course/design-patterns-javascript/)
2. [Design Patterns in TypeScript UDM](https://www.udemy.com/course/design-patterns-in-typescript/)
3. [A Tour of JavaScript & React Patterns FEM](https://frontendmasters.com/courses/tour-js-patterns/)
...
4. [JS DP freecodecamp](https://www.freecodecamp.org/news/javascript-design-patterns-explained/)
5. [JavaScript Design Patterns dofactory](https://www.dofactory.com/javascript/design-patterns)
6. [JS DP GH](https://github.com/pankajspace/07-js-design-patterns)
...
7. [Functional Java - Java Backend Bootcamp](https://www.youtube.com/playlist?list=PLqq-6Pq4lTTbobgvdemOhBH_D_sz3kD8c) 4HR
